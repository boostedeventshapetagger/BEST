...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        '/store/mc/RunIIAutumn18MiniAOD/ZprimeToTT_M2000_W20_TuneCP2_PSweights_13TeV-madgraphMLM-pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v1/40000/FC5DABDC-1271-CF47-B3C3-580596907C7B.root'
        )
                            )
