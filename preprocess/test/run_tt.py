...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        #'root://cmsxrootd.fnal.gov//store/mc/RunIISummer16MiniAODv3/ZprimeToTT_M-1000_W-300_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3-v1/100000/1EB9C330-7DC2-E811-BC7E-002590E7DFFE.root'
	)
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("preprocess_BEST_tt.root") )
