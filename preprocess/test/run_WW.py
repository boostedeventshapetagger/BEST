...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        'root://cmsxrootd-site.fnal.gov//store/mc/RunIISummer16MiniAODv3/ZprimeToWW_width0p1_M-1200_TuneCUETP8M1_13TeV-madgraph-pythia8/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3-v1/00000/F4CD60D3-5EBB-E811-9CE5-A0369FD0B142.root'
	)
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("preprocess_BEST_WW.root") )
