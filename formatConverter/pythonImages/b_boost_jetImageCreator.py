#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# bottom_boost_jetImageCreator.py /////////////////////////////////////////////////
#==================================================================================
...
upTree = uproot.open("/uscms_data/d3/bregnery/BEST/mc2017/preprocess_BEST_bb.root")["run/jetTree"]

# make file to store the images and BES variables
h5f = h5py.File("images/bottomBoostedJetImages.h5","w")
...
if plotJetImages == True:
   ...
   img.plotAverageBoostedJetImage(jetDF['jet_images'], 'boost_b', savePNG, savePDF)

   img.plotThreeBoostedJetImages(jetDF['jet_images'], 'boost_b', savePNG, savePDF)

   img.plotMolleweideBoostedJetImage(jetDF['jet_images'], 'boost_b', 31, savePNG, savePDF)
