...
upTree = uproot.open("/uscms_data/d3/bregnery/BEST/mc2017/preprocess_BEST_WW.root")["run/jetTree"]

# make file to store the images and BES variables
h5f = h5py.File("images/WBoostedJetImages.h5","w")
...
if plotJetImages == True:
   ...
   img.plotAverageBoostedJetImage(jetDF['jet_images'], 'boost_W', savePNG, savePDF)

   img.plotThreeBoostedJetImages(jetDF['jet_images'], 'boost_W', savePNG, savePDF)

   img.plotMolleweideBoostedJetImage(jetDF['jet_images'], 'boost_W', 31, savePNG, savePDF)
