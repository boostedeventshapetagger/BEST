...
h5f = h5py.File("images/ZBoostedJetImages.h5","w")
...
print "show the NaNs", jetDF['BES_vars'].columns[jetDF['BES_vars'].isna().any()].tolist()
...
if plotJetImages == True:
   ...
   img.plotAverageBoostedJetImage(jetDF['jet_images'], 'boost_Z', savePNG, savePDF)

   img.plotThreeBoostedJetImages(jetDF['jet_images'], 'boost_Z', savePNG, savePDF)

   img.plotMolleweideBoostedJetImage(jetDF['jet_images'], 'boost_Z', 31, savePNG, savePDF)
