#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Higgs_boost_jetImageCreator.py //////////////////////////////////////////////////
#==================================================================================
...
upTree = uproot.open("/uscms_data/d3/bregnery/BEST/mc2017/preprocess_BEST_HH_small.root")["run/jetTree"]

# make file to store the images and BES variables
h5f = h5py.File("images/HiggsBoostedJetImages.h5","w")
...
if plotJetImages == True:
   ...
   img.plotAverageBoostedJetImage(jetDF['jet_images'], 'boost_H', savePNG, savePDF)

   img.plotThreeBoostedJetImages(jetDF['jet_images'], 'boost_H', savePNG, savePDF)

   img.plotMolleweideBoostedJetImage(jetDF['jet_images'], 'boost_H', 31, savePNG, savePDF)
